...
const Card = (movie) => {
  return (
    <div className="flex flex-col text-zinc-800 dark:text-slate-200 bg-white dark:bg-orange-900 dark:bg-opacity-80 dark:border-slate-800 justify-center p-4 shadow-lg rounded-lg border">
      <img
